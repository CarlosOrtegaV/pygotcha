"""Scikit-learn-compatible base classes and utility functions."""
...
def _pprint(params, offset=0, printer=repr):
    ...
    See sklearn.base.BaseEstimator and sklearn/base.py for more information.
    ...
    for i, (k, v) in enumerate(sorted(params.items())):
        # use str for representing floating point numbers to get a
        # consistent representation across architectures/versions.
        this_repr = f"{k}={v!s}" if isinstance(v, float) else f"{k}={printer(v)}"
